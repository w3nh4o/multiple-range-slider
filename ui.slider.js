        ...
        _refreshHandles: function() {
            ...
            if (o.handles && o.handles.length) {                
                ...
                $.each(o.handles, function(i) {
                    ...
                    // create ranges for all handles except the last
                ...
                this.handles.each(function(i, j) {
                    ...
                    if (o.tooltips) {
                        ...
                        if (i < allHandles.length-1)
                            $('.ui-slider-tooltip', this).text($(this).attr('data-value')+' - '+allHandles.eq(i+1).attr('data-value'));
                        // if last show range from previous
                        else
                            $('.ui-slider-tooltip', this).text(allHandles.eq(i-1).attr('data-value')+' - '+$(this).attr('data-value'));
                    /*
                        if (i < allHandles.length-1)
